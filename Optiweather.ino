  ...
  void salvarDatos() {
    ...
    server.send(200, "text/html",  html1 + html2+ html3+ getssid +html4+ getpass + html5+ getmethod + html6 +getssidip +html7 + getgateway + html8+ getmascara +html9+getdns1 +html10 + getdns2 +html11+getidentikey + html12 );
...
////////////////////////////////////////////////////////
      ...
      display.clearDisplay();
        /*
      IPAddress ip_static(10,20,1,40); 
      IPAddress ip_gateway(10,20,1,1); 
        IPAddress ip_subnet(255,255,255,0);
        IPAddress ip_dns1    ( 10,1,2,156);
        IPAddress ip_dns2    ( 10,1,2,175);*/
